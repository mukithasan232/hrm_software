...
app.prepare()
  .then(async () => {
    ...
    try {
      ...
      // Note: Cron-based bulk sync is handled exclusively by the zk-worker PM2 process.
      // server.cjs only starts the realtime UDP listener for instant punch notifications via socket.io.
